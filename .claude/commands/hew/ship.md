...
3. Optionally create a Beads gate: bd create --type=gate --title="PR #N merged" --await-type=gh:pr --await-id=N
4. Add the gate as a dependency of the next epic so the agent waits for merge.
